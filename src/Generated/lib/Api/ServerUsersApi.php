...
class ServerUsersApi
{
    ...
    {
        $returnType = '\Torii\Backend\Generated\Model\UserResponse';
        $request = $this->banUserRequest($user_id, $contentType);
    ...
    public function searchUsersWithHttpInfo($limit = 20, $cursor = null, $server_user_search_request = null, string $contentType = self::contentTypes['searchUsers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Torii\Backend\Generated\Model\CursorPageResponseUserResponse',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\Torii\Backend\Generated\Model\CursorPageResponseUserResponse';
        $request = $this->searchUsersRequest($limit, $cursor, $server_user_search_request, $contentType);
